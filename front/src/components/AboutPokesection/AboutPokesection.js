      ...
      {dataAboutSpecie && dataAboutPoke && (
        <div className="aboutSection">
            ...
            <ul>
              ...
              <li className="genderBar">
                {dataAboutSpecie.gender_rate === -1 ? (
                  ...
                  <>
                    <div className="male">
                      <span>{maleGenderRatio + " %"}</span>
                      <IoMdMale size="1.5rem" color="#4d90d5" />
                    </div>
                    <div className="female">
                      <span>{femaleGenderRatio + " %"}</span>
                      <IoMdFemale size="1.5rem" color="#ec8fe6" />
                    </div>
                  </>
                )}
              </li>
          ...
          <figure className="aboutSection_Shiny">
            <img src={dataAboutPoke.sprites.front_shiny} alt="shiny_form" />
